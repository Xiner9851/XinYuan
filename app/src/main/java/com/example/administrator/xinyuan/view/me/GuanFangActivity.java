...
public class GuanFangActivity extends BaseActivity implements IDingDangMessageContact.View,View.OnClickListener {
    ...
    protected void loadData() {
        ...
        dingDanMessagePresent.loadTaunDui(xiaoji.getInt("id",0));
