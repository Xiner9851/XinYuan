 ...
 */
public class DaiFuKuanFragment extends BaseFragment implements IMyDingDangContact.View{
    ...
    protected int getLayoutId() {
        return R.layout.fragment_dai_fu_kuan;
    }
    ...
    protected void loadDate() {
        ...
        myDingDangPresent.loadMyDingDang(xiaoji.getInt("id",0),2);
