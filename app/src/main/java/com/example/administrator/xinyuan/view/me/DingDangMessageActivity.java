...
public class DingDangMessageActivity extends BaseActivity implements IDingDangMessageContact.View,View.OnClickListener{
    ...
    protected int getLayoutId() {
        return R.layout.activity_ding_dang_message;
    }
    ...
    protected void loadData() {
       dingDanMessagePresent=new DingDanMessagePresent(this);
        ...
        dingDanMessagePresent.loadShuJu(xiaoji.getInt("id",0));
