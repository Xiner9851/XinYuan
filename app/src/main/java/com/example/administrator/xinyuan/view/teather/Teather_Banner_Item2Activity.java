...
public class Teather_Banner_Item2Activity extends BaseActivity implements ITeatherTuiJieContact.View,ShouCangContact.View {
    ...
    private ImageView again_share,tuijie_shoucang,tuijie_qushoucang;
