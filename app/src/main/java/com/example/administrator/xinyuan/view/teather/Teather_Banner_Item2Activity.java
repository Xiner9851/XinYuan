...
public class Teather_Banner_Item2Activity extends BaseActivity implements ITeatherTuiJieContact.View {
    ...
    public void showData(TeatherTuiJie_Item teatherTuiJie_item) {
        TeatherTuiJie_Item.DataBean data = teatherTuiJie_item.getData();
