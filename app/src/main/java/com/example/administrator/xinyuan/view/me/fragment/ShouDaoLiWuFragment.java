 ...
 */
public class ShouDaoLiWuFragment extends BaseFragment implements IMyLiWuContact.View {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_shou_dao_li_wu;
    }
    ...
    protected void loadDate() {
        ...
        myLiWuPresent.loadMyLiWu(xiaoji.getInt("id",0),1);
