...
public class PinLunActivity extends BaseActivity implements IDingDangMessageContact.View,View.OnClickListener{
    ...
    protected void loadData() {
        ...
        dingDanMessagePresent.loadZuoYe(xiaoji.getInt("id",0));
