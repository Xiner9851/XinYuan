...
import com.example.administrator.xinyuan.view.work.Work_HuiFuActivity;
...
public class Work_PingLun_Adapter extends BaseAdapter {
    private List<WorkPingLunLieBiaoBean.DataBean.CommentsBean.ListBean> list;
    private Context context;

    public Work_PingLun_Adapter(List<WorkPingLunLieBiaoBean.DataBean.CommentsBean.ListBean> list, Context context) {
        this.list = list;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.work_pinglun_item, null);
        ...
        viewHolder.work_huifu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.putInt("pingid",list.get(position).getId());
                edit.commit();
            }
        });
        return inflate;
